...
parser.add_argument('--reconsCoef', dest="reconsCoef", type=float, default=0.5, help="Reconstruction coefficient of the arm layers")
parser.add_argument('--dict', dest="dict_size", type=int, default=16, help="Size of the feature dictionary")
...
lastArmLayer = model.get_layer(name="arm_2")
...
W_scaled *= 255
vis(W_scaled, "ArmDict.png", n=int(np.sqrt(args.dict_size)), w=12)
